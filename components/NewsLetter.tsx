const NewsLetter = () => {
  return (
    <section className="py-20 shadow-md rounded-lg dark:bg-dark/50 bg-white overflow-hidden animate-slide-up">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex flex-col md:flex-row gap-4">
              ...
              <button
                type="submit"
                className="bg-primary text-white rounded-lg px-8 py-3 hover:bg-primary/90 transc"
              >
                Subscribe
              </button>
            </form>
